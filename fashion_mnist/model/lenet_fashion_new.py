...
class LeNet5:
    ...
    def __init__(self, input_dim=(1, 28, 28),
                 conv_param_1={'filter_num': 60, 'filter_size': 5, 'pad': 2, 'stride': 1},
                 conv_param_2={'filter_num': 80, 'filter_size': 5, 'pad': 0, 'stride': 1},
                 conv_param_3={'filter_num': 120, 'filter_size': 5, 'pad': 0, 'stride': 1},
                 conv_param_4={'filter_num': 240, 'filter_size': 5, 'pad': 0, 'stride': 1},
                 weight_init_std=0.014):

        # 가중치 초기화 filter_num, input_dim[0], filter_size, filter_size
        self.params = {}
        self.params['W1'] = weight_init_std * \
                            np.random.randn(60, 1, 5, 5)
        self.params['b1'] = np.zeros(60)
        self.params['W3'] = weight_init_std * \
                            np.random.randn(80, 60, 5, 5)
        self.params['b3'] = np.zeros(80)
        self.params['W5'] = weight_init_std * \
                            np.random.randn(120, 80, 2, 2)
        self.params['b5'] = np.zeros(120)
        self.params['W7'] = weight_init_std * \
                            np.random.randn(240, 120, 2, 2)
        self.params['b7'] = np.zeros(240)
        self.params['W8'] = weight_init_std * \
                            np.random.randn(240, 120)
        self.params['b8'] = np.zeros(120)
        self.params['W9'] = weight_init_std * \
                            np.random.randn(120, 84)
        self.params['b9'] = np.zeros(84)
        ...
        self.layers['Conv5'] = Convolution(self.params['W5'], self.params['b5'],
                                           conv_param_2['stride'], conv_param_3['pad'])
        ...
        self.layers['Conv7'] = Convolution(self.params['W7'], self.params['b7'],
                                           conv_param_3['stride'], conv_param_4['pad'])
    ...
    def load_params(self, file_name="params_Lenet.pkl"):
        ...
        for i, key in enumerate(['Conv1', 'Conv3', 'Conv5', 'Conv7', 'Affine8', 'Affine9', 'Affine10']):
